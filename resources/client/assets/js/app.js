...
// window.CancelToken = window.axios.CancelToken
// window.AxiosSource = window.CancelToken.source()
...
import ImageInput from './components/ImageFileInput.vue'
...
Vue.component('image-file-input', ImageInput)
